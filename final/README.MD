...
The original benchmark uses AutoGluon, but here I focus on a traditional machine-learning baseline (Random Forest) and compare it with other common models.
